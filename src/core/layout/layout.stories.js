...
storiesOf("Core | Layout", module)
  ...
  .add("Grid", () => (
    <div
      className="sg-grids grid-container fluid scheme--brand-white"
      style={{ height: "100vh" }}
    >
      <div
      ...
      >
        ...
        <div className="cell screen460-6 screen768-10 screen768-offset-2 scheme--brand-grey">
          10 offset-2
        </div>

        <div className="cell screen460-6 screen768-4 screen768-offset-2 scheme--brand-grey">
          4 offset-2
        </div>
        <div className="cell screen460-6 screen768-4 screen768-offset-2 scheme--brand-grey">
          4 offset-2
        ...
        <div className="cell screen768-3 screen768-offset-3 scheme--brand-grey">
          3 offset-3
        </div>
        <div className="cell screen768-3 screen768-offset-2 scheme--brand-grey">
          3 offset-2
        </div>
      </div>
    </div>
  ...
  .add("Page Layout", () => (
    <main className="page-main" id="main-content" style={{ height: "100vh" }}>
      <div
